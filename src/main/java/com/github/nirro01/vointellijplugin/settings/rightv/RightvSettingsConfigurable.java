...
import static com.github.nirro01.vointellijplugin.settings.rightv.RightvSettingsComponent.*;

public class RightvSettingsConfigurable implements Configurable {

    private RightvSettingsComponent mySettingsComponent;
    ...
    public JComponent createComponent() {
        mySettingsComponent = new RightvSettingsComponent();
        return mySettingsComponent.getPanel();
    }

    @Override
    public boolean isModified() {
        RightvSettingsState settings = RightvSettingsState.getInstance();
