...
public class RightvSettingsComponent {
    ...
    private static final String TEXT_2 = "<html>In most servers the path is <b><i>/export/home/rightv/jboss</i></b> <br>Another option is <b><i>/home/rightv/jboss</i></b></html>";
    private static final String TEXT_3 = "<html>It should be similar to <b><i>C:\\repo\\rightv\\sources</i></b></html>";

    public RightvSettingsComponent() {
        initPanel();
